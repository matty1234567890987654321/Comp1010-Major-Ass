public class Songs {
    ...
    private final String duration;    // Duration of the song (e.g., "3:45")
    private final Artist artist;      // Artist who performed the song
    private final String album;       // Album the song belongs to (or null if it's a single)
