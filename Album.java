public class Album {
    private final String albumTitle; // Title of the album
    private final Artist artist; // Artist of the album
    private final Songs[] songsArray; // Array to store the songs in the album
